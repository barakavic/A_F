...
class _LoginScreenState extends State<LoginScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              Text(
                'LOGIN',
                style: AppTextStyles.h2.copyWith(fontWeight: FontWeight.bold, fontSize: 28),
              ),
              ...
              Form(
                ...
                child: Column(
                  children: [
                    ...
                    _buildInputLabel('Email, Phone or Username:'),
  ...
  InputDecoration _buildInputDecoration({bool isPassword = false, VoidCallback? onToggleVisibility}) {
