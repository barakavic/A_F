...
import 'package:front_end/screens/shared/markets_screen.dart';
          ...
          Container(
            ...
            child: Column(
              ...
              children: const [
                ...
                Text(
                  'You have 2 new updates on funded projects',
                  style: TextStyle(fontSize: 14),
                ),
                Text(
                  'Your project Ecofarm has reached 75% funding',
                  style: TextStyle(fontSize: 14),
                ),
                Text(
                  '*1 Message from Project X.',
                  style: TextStyle(fontSize: 14),
                ),
                SizedBox(
                  height: 10,
