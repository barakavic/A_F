...
class FundraiserProfile(Base):
    ...
    fundraiser_id = Column(GUID(), ForeignKey("account.account_id"), primary_key=True)
    company_name = Column(String(200))
    br_number = Column(String(50))
    industry_l1_id = Column(GUID(), ForeignKey("company_category_l1.l1_id"))
...
class CompanyCategoryL1(Base):
    ...
    l1_id = Column(GUID(), primary_key=True, default=uuid.uuid4)
...
class CompanyCategoryL2(Base):
    ...
    l2_id = Column(GUID(), primary_key=True, default=uuid.uuid4)
    l1_id = Column(GUID(), ForeignKey("company_category_l1.l1_id"))
